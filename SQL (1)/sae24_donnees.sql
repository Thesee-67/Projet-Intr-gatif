...
CREATE TABLE `donnees` (
  ...
  `nom_capteur` varchar(40) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `nom_capteur` (`nom_capteur`),
  CONSTRAINT `donnees_ibfk_1` FOREIGN KEY (`nom_capteur`) REFERENCES `capteur` (`nom_capteur`)
...
-- Dump completed on 2023-06-21 17:45:08
